                        ...
                        <div id="socialMedia" className="mb-6">
                            ...
                            <ul className="text-content-blue dark:text-slate-400 text-sm">
                                <li className="hover:text-sky-blue dark:hover:text-slate-300 cursor-pointer mb-1">
                                    <a href={social.linkedin} target="_blank" rel="noreferrer" className="flex gap-2 items-center">
                                        <span><GrLinkedin/></span>
                                        <span>Linkedin</span>
                                    </a>
                                </li>
                                <li className="hover:text-sky-blue dark:hover:text-slate-300 cursor-pointer mb-1">
                                    <a href={social.github} target="_blank" rel="noreferrer" className="flex gap-2 items-center">
                                        <span><GrGithub/></span>
                                        <span>Github</span>
                                    </a>
                                </li>
