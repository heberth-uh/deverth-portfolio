  ...
  return (
    <section className="relative bg-white dark:bg-darker-blue" id="home">
      ...
      <div className="container relative mx-auto md:flex md:justify-between px-6 xl:px-0 py-16 xl:py-36 lg:py-6 font-body">
        <div className="lg:w-4/5 xl:w-2/3 mx-auto flex flex-col justify-center md:text-left">
          <p className="font-bold md:text-lg lg:text-xl text-sky-blue mb-2">
            {t("hero.subtitle")}
          </p>
          <h3 className="text-dark-blue dark:text-white font-extrabold text-[2.80rem] leading-none md:text-6xl lg:text-7xl lg:leading-[70px]">
            <Trans
              ...
              components={{
                1: (
                  <span className="text-sky-500 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-cyan-300 dark:to-cyan-100 to-sky-blue" />
                ),
              }}
            />
          </h3>
          <div className="mt-10">
            ...
            <div className="flex justify-start flex-wrap gap-3 my-4 text-sm md:text-base">
              ...
              >
                ...
                <span className="pt-[1.5px]">GitHub</span>
              </a>
              <a
              ...
              >
                ...
                <span className="pt-[1.5px]">LinkedIn</span>
              </a>
              <a
              ...
              >
                ...
                <span className="pt-[1.5px]">{t("hero.button_contact")}</span>
              </a>
            </div>
          </div>
        </div>
        <div className="absolute z-[0] w-[16%] h-[28%] left-32 top-20 translate-x-1/2 translate-y-1/2 blue__gradient" />
        <div className="absolute z-[0] w-[10%] h-[10%] left-1/3 bottom-52 translate-x-1/2 translate-y-1/2 green__gradient" />
      </div>
      <div className="relative w-full z-[6]">
        <div className="flex flex-col items-center">
          <a
            href="#about_section"
            className="mb-4 text-sm md:text-base cursor-pointer text-content-blue dark:text-gray-400 hover:text-sky-blue dark:hover:text-gray-300"
          >
            {t("hero.button_start")}
            ...
            <span
              className={`flex flex-col items-center text-3xl animate-bounce ${toggleShowMenu ? "invisible" : ""}`}
            >
              <BiChevronDown />
            </span>
          </a>
