function SkillCard({title, imgUrl}) {
    return(
        <div className="hover:scale-105 hover:-translate-y-1 duration-150 w-[80px] md:w-[100px] h-[100px] md:h-[110px]">
            <div className="bg-gradient-to-tl from-gray-400 via-slate-400 to-slate-300 dark:from-sky-900/30 dark:via-violet-300/10 dark:to-teal-200/10 w-full h-full rounded-2xl drop-shadow-2xl">
