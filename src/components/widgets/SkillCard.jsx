function SkillCard({title, imgUrl}) {
    return(
        // <div className="hover:scale-105 hover:-translate-y-1 duration-150 dbg-dark-blue bg-gradient-to-tl from-sky-900/30 via-violet-300/10 to-teal-200/10 w-[80px] md:w-[100px] h-[100px] md:h-[110px] d-flex justify-center text-center py-6 rounded-2xl px-5">
